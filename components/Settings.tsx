...
import { Save, RefreshCw, X, Plus, HelpCircle, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="space-y-6 pb-24">
      ...
      <div className="bg-white p-6 rounded-[2rem] shadow-sm">
        ...
        <div className="space-y-4">
           ...
           <button 
             onClick={handleSave} 
             className="w-full bg-gray-800 text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-black transition-colors"
           >
